...
public class BoxingNewFragment extends AbsBoxingViewFragment implements View.OnClickListener {

    public static final String TAG = "com.github.library.pickphoto.BoxingNewFragment";
    ...
    public static BoxingNewFragment newInstance() {
        return new BoxingNewFragment();
    }
    ...
    private void initRecycleView() {
        GridLayoutManager gridLayoutManager = new MyGridLayoutManager(getActivity(), GRID_COUNT);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.choose_ok_btn) {
            ...
            if (!mIsPreview) {
                ...
                Boxing.get().withIntent(getActivity(), PreViewActivity.class, medias)
                        .start(this, BoxingNewFragment.IMAGE_PREVIEW_REQUEST_CODE, BoxingConfig.ViewMode.PRE_EDIT);
            }
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && requestCode == IMAGE_PREVIEW_REQUEST_CODE) {
            mIsPreview = false;
            boolean isBackClick = data.getBooleanExtra(PreViewActivity.EXTRA_TYPE_BACK, false);
    ...
    private class OnMediaClickListener implements View.OnClickListener {
        ...
        private void multiImageClick(int pos) {
            if (!mIsPreview) {
                ...
                mIsPreview = true;
                ArrayList<BaseMedia> medias = (ArrayList<BaseMedia>) mMediaAdapter.getSelectedMedias();
                Boxing.get().withIntent(getContext(), PreViewActivity.class, medias, pos, albumId)
                        .start(BoxingNewFragment.this, BoxingNewFragment.IMAGE_PREVIEW_REQUEST_CODE, BoxingConfig.ViewMode.EDIT);
            }
        }
    ...
    private class OnCameraClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (!mIsCamera) {
                ...
                mIsCamera = true;
                startCamera(getActivity(), BoxingNewFragment.this, BoxingFileHelper.DEFAULT_SUB_DIR);
            }
        }
    }
