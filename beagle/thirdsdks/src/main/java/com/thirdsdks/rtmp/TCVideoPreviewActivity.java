...
public class TCVideoPreviewActivity extends Activity implements View.OnClickListener, ITXLivePlayListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        record_delete = (ImageView) findViewById(R.id.record_delete);
        ...
        if (mCoverImagePath != null && !mCoverImagePath.isEmpty()) {
            if (mCoverImagePath.startsWith("http") || mCoverImagePath.startsWith("https")) {
        ...
        boolean isDelVideo = getIntent().getBooleanExtra("isDelVideo", false);
        if (isDelVideo) {
            record_delete.setVisibility(View.GONE);
        } else {
            record_delete.setVisibility(View.VISIBLE);
        }
