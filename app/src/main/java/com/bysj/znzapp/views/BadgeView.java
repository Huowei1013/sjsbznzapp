...
public class BadgeView extends AppCompatTextView {
    ...
    private void init() {
        ...
        setPadding(dip2Px(6), dip2Px(1), dip2Px(6), dip2Px(1));

        // set default background
        setBackground(9, R.color.red);
    ...
    public void setBackground(int dipRadius, int badgeColor) {
        ...
        bgDrawable.getPaint().setColor(getResources().getColor(badgeColor));
